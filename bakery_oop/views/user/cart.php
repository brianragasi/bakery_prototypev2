                    ...
                    <tbody>
                        <?php foreach ($cartItems as $item): ?>
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="py-4 px-6">
                                    <form method="post" action="../../actions/cart-actions.php" class="flex items-center">
                                        <input type="hidden" name="product_id" value="<?= $item['product_id'] ?>">
                                        <input type="number" name="quantity" value="<?= $item['quantity'] ?>" min="1" class="w-16 px-2 py-1 border rounded focus:outline-none focus:ring-2 focus:ring-primary">
                                        <button type="submit" name="update_quantity" class="ml-4 text-primary hover:underline">Update</button>
                                    </form>
                                </td>
