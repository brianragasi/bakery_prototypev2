...
if (isset($_GET['order_id'])) {
    ...
    $order = new Order();
    // Include delivery_address in the SQL query
    $sql = "SELECT o.*, p.name AS product_name, p.price AS product_price, oi.quantity AS item_quantity, o.pickup_time, o.delivery_address 
        FROM orders o
                    ...
                    <tbody>
                        <?php foreach ($orderDetails as $item): ?>
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="py-2 px-4">$<?php echo $item['product_price']; ?></td>
                                <td class="py-2 px-4">$<?php echo number_format($item['item_quantity'] * $item['product_price'], 2); ?></td> 
                            </tr>
