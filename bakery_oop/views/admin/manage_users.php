...
// Display success or error messages (centered using flexbox)
if (isset($_GET['success']) || isset($_GET['error']) || isset($_GET['message'])) { 
  ...
  } elseif (isset($_GET['message'])) { // Use correct styling for 'message'
